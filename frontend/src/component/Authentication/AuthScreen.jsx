...
import Netflix_Logo from '../../../public/assets/images/netflix-logo.png'
import TV_LOGO from '../../../public/assets/images/tv.png'
import Stranger_Things from '../../../public/assets/images/stranger-things-lg.png'
        ...
        <>
            <div className='hero-bg relative'>
                <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                    <img src={Netflix_Logo} alt='Netflix Logo' className='w-32 md:w-52' />
                    ...
                    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                        <div className='flex-1 relative'>
                            <div className='relative'>
                                <img src={Stranger_Things} alt='Stranger Things img' className='mt-4' />
                                ...
                                >
                                    <img src={Stranger_Things} alt='image' className='h-full' />
                                    <div className=' flex justify-between items-center w-full'>
                                        ...
                                        <img src={Download_Gif} alt='' className='h-12' />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className='py-10 bg-black text-white'>
                    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                        ...
                        <div className='flex-1 relative overflow-hidden'>
                            ...
                            <video
                                className='absolute top-2 left-1/2 -translate-x-1/2  h-4/6 z-10max-w-[63%]'
                                playsInline
                                autoPlay={true}
                                muted
                                loop
